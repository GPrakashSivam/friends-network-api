...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['receiver', 'status'], name='friends_fri_receive_0a1ec1_idx'),
        ),
        migrations.AddIndex(
            model_name='friends_request',
            index=models.Index(fields=['sender', 'status'], name='friends_fri_sender__5008a5_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='friends_request',
